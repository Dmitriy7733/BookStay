...
// Проверка на аутентификацию и роль пользователя ТМЗ
if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'user_tmz') {
    // Перенаправить на страницу входа или вывести сообщение об ошибке
    header('Location: index.php?page=login');
    exit();
}
include 'app/includes/header_tmz.php';
...
<div class="container mt-3">
    ...
    <div id="about_tmz">
        <h2>О сайте</h2>
        <p>Данный веб-сайт является закрытым, доступным только для зарегистрированных сотрудников ОАО "ТМЗ им. В.В.Воровского". Предназначен для оперативного доступа к технической документации в целях уменьшения затрат рабочего времени.</p>
    </div>
</div>
...
<script src="../assets/search_tmz.js"></script>
