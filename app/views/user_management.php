...
// Проверка на аутентификацию и роль менеджера
if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'manager_tmz') {
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        <a class="navbar-brand d-flex align-items-center" href="#">
            <img src="app/includes/tmz.png" alt="Логотип" style="height: 40px; margin-right: 10px;">
            Техническая документация ОГТ
        </a>
...
<div class="container mt-3">
    <form method="POST" action="index.php?page=user_management">
        <h2 class="text-center">Управление пользователями</h2>
        <h3>Выберите действия для ролей:</h3>
        <div>
            <label>
                <input type="checkbox" name="user_roles[]" value="editor_tmz"> Editor
            </label>
            <label>
                <input type="checkbox" name="user_roles[]" value="admin_tmz"> Admin
            </label>
            <label>
                <input type="checkbox" name="user_roles[]" value="user_tmz"> User
            </label>
        </div>
        <div>
    ...
    <h3>Управление индивидуальными пользователями:</h3>
    <table class="table">
        <thead>
            <tr>
                <th>ID</th>
                ...
                <tr>
                    ...
                    <td>
                        <form method="POST" action="index.php?page=user_management">
                            ...
                            <?php else: ?>
                                <button type="submit" name="action" value="unblock" class="btn btn-success">Разблокировать</button>
                            <?php endif; ?>
                        </form>
                    </td>
                </tr>
